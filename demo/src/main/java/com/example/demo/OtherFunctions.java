...
public class OtherFunctions {
    ...
    public static void writeNewPagesFile(String name) throws IOException {
        ...
        String ss = modifyJsContent(s, capitalizedString);
        String fileName = "C:\\Windows\\System32\\my-app12\\src\\pages\\" + name + ".js";
    ...
    public static String getOrigName() throws IOException {
        String origFileCont = readJsFile("C:\\Windows\\System32\\my-app12\\src\\App.js");
    ...
    public static String editLinksAppFile(String name, String origName, String newContentRev1) throws IOException {
        ...
        String origNameWithSpaces = origName.replace('_', ' ');
        String newNameWithSpaces = name.replace('_', ' ');
    ...
    public static String addImportLine(String name, String newContentRev2) throws IOException {
        String desLine = "import " + name + " from " + "'./pages/" + name + "';";
