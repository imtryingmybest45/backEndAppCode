...
public class OtherFunctions {
    ...
    public static void commitMultipleFiles(Map<String, String> filesContent, String gitToken, String repoOwner, String repoName, String branchName) throws IOException {
